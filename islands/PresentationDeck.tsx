  ...
  const slides = [
    {
      ...
      content: (
        <div class="flex flex-col md:flex-row items-center justify-center space-x-0 md:space-x-12 space-y-8 md:space-y-0 slide-in z-10 relative w-full h-full min-h-[60vh] max-w-6xl px-4">
          ...
          <div
            class="absolute inset-[-50%] -z-10 flex items-center justify-center opacity-50 pointer-events-none mix-blend-screen"
            style={{
              maskImage:
          ...
          >
            <svg
              viewBox="0 0 800 800"
              class="w-full h-full max-w-none opacity-60"
            >
              <g stroke="#22d3ee" stroke-width="0.5" fill="none">
                ...
                <polygon
                  points="400,50 750,250 750,550 400,750 50,550 50,250"
                  stroke-dasharray="4 8"
                  opacity="0.3"
                />
                <polygon
                  points="400,100 650,250 650,450 400,600 150,450 150,250"
                  opacity="0.4"
                />
                <polygon
                  points="400,150 550,250 550,350 400,450 250,350 250,250"
                ...
                {/* Matrix Lattice */}
                <path
                  d="M 400 50 L 400 750 M 50 250 L 750 550 M 50 550 L 750 250"
                  stroke-width="0.2"
                  opacity="0.5"
                />
          ...
          <div class="flex flex-col items-start w-full md:w-1/2">
            <div class="mb-4">
              <span class="inline-flex items-center space-x-2 py-1.5 px-4 rounded text-zinc-400 text-xs font-mono tracking-[0.2em] uppercase border border-white/5 bg-white/5">
                <div class="w-1.5 h-1.5 rounded-full bg-cyan-400 opacity-80">
                </div>
            ...
            <h1 class="text-5xl md:text-7xl font-light tracking-tight text-white drop-shadow-sm text-left">
              Google Cloud <br />
              <span class="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-zinc-100 to-zinc-500">
                Vector Search
              </span>
            </h1>
            <p class="text-lg font-light text-zinc-400 mt-6 leading-relaxed">
              A state-of-the-art serverless architecture migration transitioning
              AI workloads away from monolithic constraints. Powered entirely by
              {" "}
              <span class="text-zinc-200">Google Cloud Run</span> and{" "}
              <span class="text-zinc-200">Firestore</span>.
            </p>
            <div class="flex items-center space-x-6 mt-8 mb-2">
              <div class="flex items-center text-[10px] sm:text-xs font-mono uppercase tracking-widest text-amber-400">
                <div class="w-1.5 h-1.5 rounded-full bg-amber-400 mr-2"></div>
                {" "}
                Cheaper
              </div>
              <div class="flex items-center text-[10px] sm:text-xs font-mono uppercase tracking-widest text-blue-400">
                <div class="w-1.5 h-1.5 rounded-full bg-blue-400 mr-2"></div>
                {" "}
                Faster
              </div>
              <div class="flex items-center text-[10px] sm:text-xs font-mono uppercase tracking-widest text-emerald-400">
            ...
            <div class="mt-8 flex items-center space-x-4 border-t border-white/10 pt-6 w-full">
              <img
                src="/eric_warriner.jpg"
                class="w-10 h-10 rounded-full border border-white/10 object-cover"
                alt="Eric S. Warriner"
              />
              <div class="flex flex-col">
                <span class="text-zinc-200 font-medium text-sm">
                  Eric S. Warriner
                </span>
                <span class="text-[10px] text-cyan-400 font-mono tracking-widest uppercase">
                  Cloud Application Modernization Engineer
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="w-full md:w-1/2 flex justify-end">
            <div class="bg-black/60 backdrop-blur-xl border border-white/10 p-8 rounded-2xl w-full max-w-[360px] shadow-[0_0_50px_rgba(0,0,0,0.5)] glow-border-hover relative">
              <div class="absolute inset-0 bg-cyan-500/5 blur-3xl rounded-2xl">
              </div>
              ...
              <div class="space-y-4 relative z-10">
                {[
                  ...
                  {
                    label: "Education",
                    title: "Vector Geometry & Synthesis",
                    color: "text-teal-400",
                    dot: "bg-teal-400",
                  },
                  {
                    label: "Architecture",
                    title: "Cloud Edge & Future-Proofing",
                    color: "text-cyan-400",
                    dot: "bg-cyan-400",
                  },
                  {
                    label: "Security",
                    title: "Zero-Trust Privacy & Trace",
                    color: "text-emerald-400",
                    dot: "bg-emerald-400",
                  },
                  {
                    label: "Business Case",
                    title: "TCO & Executive Value",
                  ...
                  <div
                    key={item.label}
                    class="flex items-start space-x-3 group relative hover:translate-x-1 transition-transform cursor-default"
                  >
                    {/* Vertical connecting line */}
                    {i !== arr.length - 1 && (
                      <div class="absolute left-[3px] top-4 bottom-[-16px] w-[1px] bg-white/5 transition-colors">
                      </div>
                    )}

                    <div
                      class={`w-2 h-2 rounded-full mt-1.5 shrink-0 ${item.dot} ${
                        item.highlight
                          ? "opacity-100 animate-pulse"
                          : "opacity-40"
                      } shadow-[0_0_8px_currentColor] group-hover:opacity-100 transition-opacity`}
                    >
                    </div>

                    <div class="flex flex-col -mt-0.5">
                      <span
                        class={`text-[9px] font-mono uppercase tracking-[0.15em] ${item.color} ${
                          item.highlight ? "opacity-100" : "opacity-60"
                        }`}
                      >
                        {item.label}
                      </span>
                      <span
                        class={`font-light text-[13px] ${
                          item.highlight
        ...
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              Legacy databases are bottlenecking AI workloads. Oracle 23ai
              tangles application logic directly with proprietary database
              functions — blocking agility at the architecture level.
            </p>
          </div>
          ...
          <div class="flex flex-col md:flex-row items-stretch gap-6 w-full justify-center mt-8">
            <div class="flex flex-col space-y-4 w-full max-w-sm">
              <div class="bg-red-950/20 border border-red-500/20 p-5 rounded-xl flex flex-col items-start relative h-1/2">
                ...
                <h3 class="text-lg font-semibold text-zinc-200 mb-1">
                  Monolithic Bottleneck
                </h3>
                <p class="text-xs text-zinc-400 leading-relaxed">
                  Tightly coupled monoliths force massive cross-domain sync
                  delays and lock-in.
                </p>
              </div>
              <div class="bg-red-950/20 border border-red-500/20 p-5 rounded-xl flex flex-col items-start relative h-1/2">
                  ...
                  >
                    ...
                    <g>
                      ...
                      <animateTransform
                        attributeName="transform"
                        type="rotate"
                        values="0 12 15; -5 12 15; 5 12 15; 0 12 15; 0 12 15"
                ...
                <h3 class="text-lg font-semibold text-zinc-200 mb-1">
                  The FPGA Hardware Trap
                </h3>
                <p class="text-xs text-zinc-400 leading-relaxed">
                  Proprietary FPGA machines inherently block the dynamic
                  upgrades necessary to pivot to newer ML models.
                </p>
              </div>
            </div>
            ...
            <div class="bg-cyan-900/20 border border-cyan-500/30 p-8 rounded-xl w-full max-w-md flex flex-col items-center justify-center text-center space-y-4 relative glow-border-hover shadow-[0_0_20px_rgba(34,211,238,0.1)]">
              <div class="absolute inset-0 bg-cyan-500/5 blur-xl mix-blend-screen animate-pulse pointer-events-none">
              </div>
              <div class="w-20 h-20 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 relative z-10 mb-2">
                ...
                >
                  ...
                  <g>
                    ...
                    <path
                      d="M12 3 L12 9 M20 17 L15 14 M4 17 L9 14"
              ...
              <h3 class="text-2xl font-semibold text-zinc-200 relative z-10">
                Decoupled Serverless Vision
              </h3>
              <p class="text-sm text-zinc-400 leading-relaxed relative z-10">
                We propose separating intelligence from storage. By isolating
                inference workloads strictly to browser-edge devices, we enable
                "hot-swappable" models that completely bypass static hardware
                ceilings.
              </p>
            </div>
          </div>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              A vector is a numerical fingerprint extracted from a face. The
              closer two vectors sit in geometric space, the more visually
              identical the faces are.
            </p>
          </div>
          ...
          <div class="w-full max-w-3xl bg-zinc-900/40 p-8 rounded-2xl border border-white/5 relative overflow-hidden glow-border-hover flex flex-col md:flex-row items-center gap-8 shadow-2xl mt-4">
            <div class="absolute inset-0 bg-teal-500/5 blur-3xl mix-blend-screen animate-pulse pointer-events-none">
            </div>
            ...
            <div class="w-2/3 h-full z-10 border-l border-white/10 pl-8 flex items-center justify-center">
              <svg viewBox="0 0 200 150" class="w-full h-full max-w-[300px]">
                ...
                />
                <path
                  d="M 185 125 L 190 130 L 185 135 M 15 15 L 20 10 L 25 15"
                  fill="none"
                  stroke="rgba(255,255,255,0.2)"
                  stroke-width="1"
                  stroke-linecap="round"
                ...
                <circle cx="20" cy="130" r="4" fill="#38bdf8">
                  <animate
                    attributeName="cx"
                    values="20;50;50;50;20"
                    dur="8s"
                    repeatCount="indefinite"
                  />
                  <animate
                    attributeName="cy"
                    values="130;70;70;70;130"
                    dur="8s"
                    repeatCount="indefinite"
                  />
                </circle>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              Traditional databases run filters and vector searches separately,
              causing massive latency. Firestore natively fuses relational
              metadata (Age, Gender) directly inside the Vector Index — one
              query, zero overhead.
            </p>
          </div>
          ...
          <div class="flex flex-col md:flex-row items-center gap-12 w-full justify-center mt-8">
            <div class="flex flex-col max-w-sm space-y-6">
              <div class="p-6 bg-zinc-900/50 rounded-xl border border-white/5 glow-border-hover">
                <h4 class="font-bold text-white flex items-center mb-2">
                  <div class="w-1.5 h-1.5 rounded-full bg-blue-500 mr-2">
                  </div>Traditional SQL
                </h4>
              ...
              <div class="p-6 bg-zinc-900/50 rounded-xl border border-white/5 glow-border-hover">
                <h4 class="font-bold text-white flex items-center mb-2">
                  <div class="w-1.5 h-1.5 rounded-full bg-cyan-400 mr-2">
                  </div>Vector Proximity
                </h4>
                <p class="text-xs text-zinc-400 font-mono">
            ...
            <div class="w-72 h-72 relative flex items-center justify-center bg-black/40 rounded-full border border-white/5 shadow-[0_0_50px_rgba(99,102,241,0.15)]">
              <svg viewBox="0 0 100 100" class="w-3/4 h-3/4">
                ...
                >
                  <polygon
                    points="50,20 80,40 70,80 30,70"
                    stroke-dasharray="2 2"
                  />
                ...
                {/* Convergence rays */}
                <path
                  d="M 25 25 L 40 40 M 65 30 L 50 45 M 50 70 L 45 55 M 25 60 L 40 50"
                  stroke="#818cf8"
                  stroke-width="1"
                  stroke-dasharray="2 4"
                >
              ...
              <div class="absolute inset-0 bg-indigo-500/10 blur-2xl rounded-full mix-blend-screen animate-pulse">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-center w-full max-w-6xl space-y-12 slide-in px-4 mt-8">
          <div class="text-center space-y-4">
            <h2
              ...
              class="text-2xl md:text-4xl font-semibold text-white tracking-tight cursor-pointer group flex items-center justify-center space-x-2"
            >
              <span>
                Cross-Pillar{" "}
              ...
              <span
                class="opacity-0 group-hover:opacity-100 transition-opacity text-zinc-500 bg-white/5 rounded-full w-5 h-5 flex items-center justify-center text-[10px] font-mono border border-white/10"
                title="Speaker Notes"
              >
                i
              </span>
            </h2>
            <p class="text-zinc-400 font-light max-w-2xl mx-auto">
              Bridging two distinct technical domains: highly-distributed{" "}
              <span class="text-white">Application Modernization</span>{" "}
              on the edge seamlessly integrating into{" "}
              <span class="text-white">Data &amp; AI</span> in the Cloud.
            </p>
          </div>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full relative">
            {/* Background connection line for desktop */}
            <div class="hidden md:block absolute top-[28%] left-[10%] right-[10%] h-[1px] bg-gradient-to-r from-blue-500/20 via-cyan-400/30 to-purple-500/20 z-0">
            </div>
            ...
            <div class="flex flex-col p-8 rounded-xl transition-all duration-500 hover:-translate-y-1 border border-white/10 bg-zinc-900/40 backdrop-blur-sm group glow-border-hover relative overflow-hidden z-10">
              <div class="absolute top-0 right-0 bg-blue-500/20 text-blue-200 text-[9px] font-mono tracking-widest uppercase px-2 py-1 rounded-bl-lg">
                Domain 1: App Mod
              </div>
              <div class="absolute inset-0 bg-blue-500/5 group-hover:bg-blue-500/10 transition-colors delay-100 mix-blend-screen rounded-xl blur-xl">
              </div>
              <div class="h-14 w-14 border border-white/10 rounded-xl flex items-center justify-center mb-6 mt-4 bg-black text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.1)] group-hover:shadow-[0_0_25px_rgba(59,130,246,0.3)] transition-all relative">
                <svg viewBox="0 0 50 50" class="w-8 h-8">
                  ...
                  <g transform="translate(15, 22)">
                    ...
                    <path
                      d="M 7 10 L 13 10 M 10 7 L 10 13"
                      stroke="currentColor"
                      stroke-width="1"
                    />
                  </g>
              ...
              <h3 class="text-lg font-semibold text-zinc-100 mb-2 tracking-wide z-10">
                Client ML Inference
              </h3>
              <p class="text-zinc-400 text-sm leading-relaxed z-10">
                Generating precise 512-dimensional identity embeddings locally
                in the browser leveraging ArcFace ResNet-100 via ONNX
                WebAssembly.
              </p>
            </div>
            ...
            <div class="flex flex-col p-8 rounded-xl transition-all duration-500 hover:-translate-y-1 border border-white/10 bg-zinc-900/40 backdrop-blur-sm group glow-border-hover relative overflow-hidden z-10">
              <div class="absolute top-0 right-0 bg-cyan-500/20 text-cyan-200 text-[9px] font-mono tracking-widest uppercase px-2 py-1 rounded-bl-lg">
                Domain 1: App Mod
              </div>
              <div class="absolute inset-0 bg-cyan-500/5 group-hover:bg-cyan-500/10 transition-colors delay-100 mix-blend-screen rounded-xl blur-xl">
              </div>
              <div class="h-14 w-14 border border-white/10 rounded-xl flex items-center justify-center mb-6 mt-4 bg-black text-cyan-400 shadow-[0_0_15px_rgba(34,211,238,0.1)] group-hover:shadow-[0_0_25px_rgba(34,211,238,0.3)] transition-all relative">
                <svg viewBox="0 0 50 50" class="w-8 h-8">
                  ...
                  {/* Neural Hub */}
                  <path
                    d="M 25 25 L 10 25 M 25 25 L 40 15 M 25 25 L 40 35"
                    stroke="currentColor"
                    stroke-width="1"
                    stroke-dasharray="2 2"
                    opacity="0.5"
                  ...
                  <path
                    d="M 22 15 L 28 25 L 20 25 L 28 35"
                    fill="none"
                    stroke="currentColor"
                    stroke-width="2"
                    stroke-linejoin="round"
              ...
              <p class="text-zinc-400 text-sm leading-relaxed z-10">
                Google Cloud Run executing elastically at scale, replacing heavy
                legacy middleware with a streamlined TypeScript container
                architecture.
              </p>
            </div>
            ...
            <div class="flex flex-col p-8 rounded-xl transition-all duration-500 hover:-translate-y-1 border border-white/10 bg-zinc-900/40 backdrop-blur-sm group glow-border-hover relative overflow-hidden z-10">
              <div class="absolute top-0 right-0 bg-purple-500/20 text-purple-200 text-[9px] font-mono tracking-widest uppercase px-2 py-1 rounded-bl-lg">
                Domain 2: Data &amp; AI
              </div>
              <div class="absolute inset-0 bg-purple-500/5 group-hover:bg-purple-500/10 transition-colors delay-100 mix-blend-screen rounded-xl blur-xl">
              </div>
              ...
              <p class="text-zinc-400 text-sm leading-relaxed z-10">
                Executing rapid{" "}
                <code class="bg-black border border-white/5 px-1.5 py-0.5 rounded text-xs text-zinc-300 font-mono">
                  findNearest
                </code>{" "}
                vector queries directly on Google Cloud to locate highly exact
                matches.
              </p>
            </div>
          </div>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              ArcFace projects each face into a 512-dimensional hypersphere
              using deep angular separation — running entirely within your
          ...
          <div class="flex flex-col md:flex-row items-center gap-12 w-full justify-center">
            ...
            <div class="w-64 h-64 relative flex items-center justify-center bg-black/40 rounded-full border border-white/5 shadow-[0_0_40px_rgba(34,211,238,0.1)]">
              ...
              <div class="absolute inset-0 bg-cyan-400/20 blur-2xl rounded-full mix-blend-screen animate-pulse">
              </div>
            </div>
            ...
            <div class="flex flex-col space-y-6 max-w-md">
              <div class="bg-zinc-900/50 p-6 rounded-xl border border-white/5 glow-border-hover">
                <h4 class="text-white font-semibold flex items-center space-x-2">
                  <span class="w-1.5 h-1.5 rounded-full bg-cyan-400 block">
                  </span>
                  <span>ResNet-100 Architecture</span>
                </h4>
                <p class="text-zinc-400 text-sm mt-2">
                  Deeper mathematical extraction than MobileNet, ignoring
                  lighting, angle, or accessories to strictly match facial bone
              ...
              <div class="bg-zinc-900/50 p-6 rounded-xl border border-white/5 glow-border-hover">
                <h4 class="text-white font-semibold flex items-center space-x-2">
                  ...
                  <span>512-Dimensional Accuracy</span>
                </h4>
                <p class="text-zinc-400 text-sm mt-2">
                  Yields mathematically undeniable Euclidean distance
                  similarities, shrinking false-positive boundaries completely
                  natively in your RAM.
                </p>
              </div>
            </div>
          </div>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              Escape the hardware trap. Proprietary FPGA machines rigidly lock
              you into outdated machine learning chips. This decentralized
              edge-cloud architecture abstracts intelligence entirely into
              software.
            </p>
          </div>
          ...
          <div class="flex flex-col md:flex-row items-center gap-12 w-full justify-center mt-8">
            <div class="flex flex-col space-y-6 max-w-md">
              <div class="bg-zinc-900/50 p-6 rounded-xl border border-white/5 glow-border-hover">
                <h4 class="text-white font-semibold flex items-center space-x-2">
                  <span class="w-1.5 h-1.5 rounded-full bg-purple-400 block">
                  </span>
                  <span>Instant Model Hot-Swapping</span>
                </h4>
                <p class="text-zinc-400 text-sm mt-2">
                  When a new breakthrough vision model releases, simply swap the
                  model file. Zero hardware changes required. Instant iteration.
                </p>
              </div>
              <div class="bg-zinc-900/50 p-6 rounded-xl border border-white/5 glow-border-hover">
                <h4 class="text-white font-semibold flex items-center space-x-2">
                  ...
                  <span>Containerized Scale</span>
                </h4>
                <p class="text-zinc-400 text-sm mt-2">
                  Containerized on Google Cloud Run, scaling to millions of
                  requests instantly. No server racks to order — serverless
                  infrastructure handles global demand automatically.
                </p>
              </div>
            </div>
            ...
            <div class="w-64 h-64 relative flex items-center justify-center bg-black/40 rounded-xl border border-white/5 shadow-[0_0_40px_rgba(192,132,252,0.1)] overflow-hidden">
              <svg
                viewBox="0 0 100 100"
                class="w-full h-full text-purple-400 absolute inset-0"
              >
                {/* Background Grid */}
                <pattern
                  id="grid"
                ...
                {/* Cloud Hub */}
                <path
                  d="M 30 50 Q 30 35 45 35 Q 50 25 65 30 Q 75 35 75 50 Q 80 60 65 60 L 35 60 Q 20 60 30 50 Z"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="1.5"
                  stroke-linecap="round"
                ...
                <g>
                  ...
                  />
                  <path
                    d="M 45 77 L 55 77 M 45 80 L 52 80"
                    stroke="#22d3ee"
                    stroke-width="0.5"
                    stroke-linecap="round"
                  />
              ...
              <div class="absolute inset-0 bg-purple-400/10 blur-xl mix-blend-screen animate-pulse">
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              Raw facial imagery never leaves the device. Only an irreversible
              numerical matrix is transmitted to the cloud. GDPR compliance is
              built in by design.
            </p>
          </div>
          ...
          <div class="w-full max-w-3xl bg-zinc-900/50 p-8 rounded-2xl border border-emerald-500/10 shadow-[0_0_40px_rgba(16,185,129,0.05)] text-center relative overflow-hidden">
            <svg
              viewBox="0 0 200 100"
              class="w-full h-40 text-emerald-400 z-10 relative"
            >
              {/* Laptop */}
              <rect
                x="20"
              ...
              {/* Secure Cloud DB */}
              <path
                d="M 140 50 Q 140 35 155 35 Q 160 25 175 30 Q 185 35 185 50 Q 190 60 175 60 L 145 60 Q 130 60 140 50 Z"
                fill="none"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
              ...
              />
              <path
                d="M 160 40 V 35 A 3 3 0 0 1 166 35 V 40"
                fill="none"
                stroke="currentColor"
                stroke-width="1.5"
              />
            </svg>
            <div class="absolute inset-0 bg-emerald-400/5 blur-3xl rounded-full mix-blend-screen animate-pulse">
            </div>
          </div>
        </div>
      ),
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-6xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              Following the data from camera to cloud. Every hop is designed to
              ensure biometric imagery stays on the device — only numbers cross
              the wire.
            </p>
          </div>
          ...
          <div class="w-full h-40 bg-zinc-900/40 rounded-2xl border border-white/5 relative flex items-center justify-around px-12 shadow-2xl overflow-hidden glow-border-hover">
            ...
            <div class="absolute left-10 right-10 h-[1px] bg-zinc-800 top-1/2 -translate-y-1/2">
            </div>
            ...
            <div
              ...
              style={{
                animation:
                  "payloadPing 5.2s cubic-bezier(0.45, 0, 0.55, 1) infinite",
                boxShadow:
                  "0 0 8px rgba(232,121,249,0.4), 0 0 20px rgba(232,121,249,0.15)",
              }}
            >
            </div>
            ...
            <div class="z-10 flex flex-col items-center relative bg-[#050505] p-2 rounded-full ring-4 ring-[#050505]">
              ...
              <div class="mt-4 text-[10px] uppercase tracking-widest font-mono text-zinc-400 text-center">
                Web Client<br />
                <span class="text-fuchsia-400">WebGL ONNX</span>
              </div>
            </div>
            ...
            <div class="z-10 flex flex-col items-center relative bg-[#050505] p-2 rounded-full ring-4 ring-[#050505]">
              <div class="w-16 h-16 rounded-full border border-blue-400/30 flex items-center justify-center bg-blue-400/5">
                <span class="text-blue-400 font-mono text-xl font-bold">
                  [ ]
                </span>
              </div>
              <div class="mt-4 text-[10px] uppercase tracking-widest font-mono text-zinc-400 text-center">
                Irreversible Matrix<br />
                <span class="text-blue-400">2KB Vector</span>
              </div>
            </div>
            ...
            <div class="z-10 flex flex-col items-center relative bg-[#050505] p-2 rounded-full ring-4 ring-[#050505]">
              ...
              <div class="mt-4 text-[10px] uppercase tracking-widest font-mono text-zinc-400 text-center">
                Application Edge<br />
                <span class="text-teal-400">Global Firewall</span>
              </div>
            </div>
            ...
            <div class="z-10 flex flex-col items-center relative bg-[#050505] p-2 rounded-full ring-4 ring-[#050505]">
              ...
              <div class="mt-4 text-[10px] uppercase tracking-widest font-mono text-zinc-400 text-center">
                Firestore<br />
                <span class="text-cyan-400">Native Execution</span>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              Eliminate $500K+ FPGA hardware purchases and Oracle licensing.
              Cloud Run scales to zero when idle — your infrastructure cost
              drops to nothing.
            </p>
          </div>
          ...
          <div class="flex items-center justify-center space-x-6 mb-2">
            <div class="text-center">
              <div class="text-4xl md:text-5xl font-bold text-red-400 line-through opacity-60 font-mono">
                $500K+
              </div>
              <div class="text-[10px] text-zinc-500 font-mono uppercase tracking-widest mt-1">
                Legacy CapEx
              </div>
            </div>
            <svg
            ...
            <div class="text-center">
              <div class="text-4xl md:text-5xl font-bold text-amber-400 font-mono">
                $0
              </div>
              <div class="text-[10px] text-zinc-500 font-mono uppercase tracking-widest mt-1">
                Idle Cost
          ...
          <div class="flex flex-col md:flex-row items-center gap-12 w-full justify-center">
            <div class="flex flex-col items-center p-6 bg-red-950/20 border border-red-500/20 rounded-xl relative opacity-50">
              ...
              <div class="mt-4 font-mono text-xs uppercase tracking-widest text-red-400">
                On-Prem FPGA
              </div>
            </div>
            ...
            <div class="flex flex-col items-center p-6 bg-amber-900/10 border border-amber-500/30 rounded-xl glow-border-hover relative">
              <div class="absolute inset-0 bg-amber-400/5 blur-xl mix-blend-screen animate-pulse">
              </div>
              <svg viewBox="0 0 100 100" class="w-32 h-32 text-amber-400">
                <path
                  d="M 30 60 Q 30 40 45 40 Q 50 25 65 30 Q 75 35 75 50 Q 85 60 70 70 L 35 70 Q 20 70 30 60 Z"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="1.5"
                  stroke-linecap="round"
              ...
              <div class="mt-4 font-mono text-xs uppercase tracking-widest text-amber-400">
                Serverless Run
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light leading-relaxed">
              Legacy vector search required hundreds of lines of custom drivers
              and specialized FPGA servers. We replaced all of it with a single
              native cloud function.{" "}
              <span class="text-white font-medium">
                This completely eliminates specialized DBA bottlenecks, slashes
                lifecycle maintenance overhead, and accelerates our
                time-to-market from months down to a single sprint.
              </span>
            </p>
          </div>
          ...
          <div class="flex items-center justify-center space-x-8 mb-[-20px] ml-[-20px]">
            ...
            <div class="flex items-center border-l border-white/10 pl-8 space-x-4">
              <div class="text-6xl md:text-7xl font-bold text-blue-400 font-mono h-[72px] overflow-hidden relative w-[120px] flex justify-end items-center">
                <div
                  class="flex flex-col items-end absolute top-0 right-0 w-full"
                  style={{
                    animation:
                      "odometerScroll 3.5s cubic-bezier(0.2, 0.8, 0.2, 1) forwards 2s",
                  }}
                >
                  <style
                  ...
                  />
                  <div class="h-[72px] flex items-center justify-end leading-none">
                    999
                  </div>
                  <div class="h-[72px] flex items-center justify-end leading-none">
                    842
              ...
              <div class="text-left mt-2">
                ...
                <div class="text-zinc-500 text-[10px] font-mono uppercase tracking-widest mt-1">
          ...
          <div class="w-full max-w-3xl bg-[#0d1117] p-8 rounded-xl border border-white/10 shadow-2xl relative group mt-4 overflow-hidden">
            ...
            <svg
              class="absolute inset-0 w-full h-full pointer-events-none z-20 rounded-xl"
            ...
            <div class="absolute right-4 top-4 text-[10px] font-mono text-cyan-400 uppercase tracking-widest border border-cyan-400/20 bg-cyan-400/10 py-1.5 px-3 rounded z-10">
              Edge Function
            </div>
            <div class="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-400 to-indigo-600 rounded-l-xl">
            </div>
...
<span class="text-slate-500 italic">// 0 Server Scaling. 0 Matrix Math Required. PURE VELOCITY.</span>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-7xl space-y-10 slide-in px-4">
          ...
          <div class="w-full flex flex-col md:flex-row items-stretch gap-5 relative mt-2">
            {/* CIO Panel */}
            <div
              class="w-full md:w-1/3 bg-zinc-900/60 border border-white/5 rounded-2xl p-6 relative overflow-hidden group opacity-0"
              style={{
                animation:
                  "slideFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards 0.5s",
              }}
            >
              <div class="absolute inset-0 bg-blue-500/5 group-hover:bg-blue-500/10 transition-colors">
              </div>
              <h3 class="text-white text-xl font-bold mb-5 flex items-center relative z-10">
                <span class="bg-blue-500/20 text-blue-400 px-2.5 py-1 rounded text-xs font-mono mr-3 tracking-widest">
                  CIO
                </span>{" "}
                Stability
              </h3>
              ...
              <ul class="space-y-5 text-zinc-400 relative z-10">
                <div class="flex items-start">
                  <svg
                    class="w-5 h-5 text-blue-400 mr-3 mt-0.5 shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    <h4 class="text-zinc-200 font-semibold text-sm mb-0.5">
                      GDPR Compliance
                    </h4>
                    <p class="text-xs leading-relaxed">
                      Biometric data never leaves the browser. Zero regulatory
                      exposure.
                    </p>
                  </div>
                </div>
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-xs leading-relaxed">
                      Multi-region failover across continent zones
                      automatically.
                    </p>
                  </div>
                </div>
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-xs leading-relaxed">
                      No single point of failure. Edge clusters self-heal
                      globally.
                    </p>
                  </div>
                </div>
            ...
            {/* CFO Panel */}
            <div
              class="w-full md:w-1/3 bg-zinc-900/60 border border-emerald-500/10 rounded-2xl p-6 relative overflow-hidden group opacity-0"
              style={{
                animation:
                  "slideFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards 0.8s",
              }}
            >
              <div class="absolute inset-0 bg-emerald-500/5 group-hover:bg-emerald-500/10 transition-colors">
              </div>
              <h3 class="text-white text-xl font-bold mb-5 flex items-center relative z-10">
                <span class="bg-emerald-500/20 text-emerald-400 px-2.5 py-1 rounded text-xs font-mono mr-3 tracking-widest">
                  CFO
                </span>{" "}
                Financials
              </h3>
              ...
              <ul class="space-y-5 text-zinc-400 relative z-10">
                <div class="flex items-start">
                  ...
                  >
                    ...
                    >
                      <animate
                        ...
                        dur="3s"
                        calcMode="spline"
                        keySplines="0.4 0 0.2 1; 1 0 0 1"
                        repeatCount="indefinite"
                      />
                    </path>
                  </svg>
                  <div>
                    ...
                    <p class="text-xs leading-relaxed">
                      Converts $500K+ capital hardware purchases to
                      pay-per-query consumption billing.
                    </p>
                  </div>
                </div>
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-xs leading-relaxed">
                      Oracle DB licensing (~$47.5K/processor/yr) replaced by
                      Firestore with zero seat fees.
                    </p>
                  </div>
                </div>
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-xs leading-relaxed">
                      No 3-5 year FPGA hardware lifecycle. Cloud assets never
            ...
            <div
              ...
              style={{
                animation:
                  "slideFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards 1.1s",
              }}
            >
              <div class="absolute inset-0 bg-amber-500/5 group-hover:bg-amber-500/10 transition-colors">
              </div>
              <h3 class="text-white text-xl font-bold mb-5 flex items-center relative z-10">
                <span class="bg-amber-500/20 text-amber-400 px-2.5 py-1 rounded text-xs font-mono mr-3 tracking-widest">
                  CPO
                </span>{" "}
                Agility
              </h3>
              ...
              <ul class="space-y-5 text-zinc-400 relative z-10">
                <div class="flex items-start">
                  <svg
                    class="w-5 h-5 text-amber-400 mr-3 mt-0.5 shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    ...
                    <p class="text-xs leading-relaxed">
                      Skip 6-month hardware procurement. Ship features in days,
                      not quarters.
                    </p>
                  </div>
                </div>
                <div class="flex items-start">
                    ...
                    >
                      <path d="M5 3v4M3 5h4M6 17v4m-2-2h4">
                        <animateTransform
                          attributeName="transform"
                          type="rotate"
                          values="0 5 5; 90 5 5; 0 5 5; 0 5 5"
                      ...
                      <path
                        d="M21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3l2.286 6.857L21 12z"
                        fill="#fbbf24"
                        fill-opacity="0"
                      >
                        <animate
                  ...
                  <div>
                    ...
                    <p class="text-xs leading-relaxed">
                      Hot-swap to the latest ML models from HuggingFace
                      instantly. No hardware refresh.
                    </p>
                  </div>
                </div>
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-xs leading-relaxed">
                      Sub-100ms semantic search directly lifts conversion rates
                      and user engagement.
                    </p>
                  </div>
                </div>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            <h2 class="text-3xl md:text-5xl font-semibold text-white tracking-tight">
              Implementation{" "}
              <span class="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-indigo-600">
                Timeline & Plan
              </span>
            </h2>
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              Migrating from Oracle to Google Serverless is mapped aggressively
              into a 6-week technical schedule.
            </p>
          </div>
          ...
          <div class="w-full max-w-3xl flex flex-col space-y-4 relative mt-8">
            ...
            {/* The Track */}
            <div class="absolute left-[38px] top-6 bottom-10 w-[2px] bg-zinc-800 z-0 rounded-full">
            </div>

            {/* The Active Laser Line */}
            <div
              class="absolute left-[38px] top-6 bottom-10 w-[3px] bg-gradient-to-b from-indigo-500 via-cyan-500 to-emerald-500 z-0 origin-top rounded-full shadow-[0_0_10px_rgba(6,182,212,0.5)]"
              style={{
                animation:
                  "lineDrawDown 3s cubic-bezier(0.4, 0, 0.2, 1) forwards 1s",
                transform: "scaleY(0)",
              }}
            >
            </div>
            ...
            <div class="flex items-center space-x-6 relative z-10 w-full group">
              <div class="w-20 font-mono text-xs text-zinc-500 text-right shrink-0">
                Wk 1-2
              </div>
              <div class="w-6 h-6 rounded-full bg-black border-2 border-indigo-400 shrink-0 shadow-[0_0_15px_rgba(129,140,248,0.4)] flex items-center justify-center relative">
                ...
                <div
                  class="absolute inset-0 rounded-full bg-indigo-400 opacity-0"
                  style={{
                    animation:
                      "pulseRing 1.5s ease-out forwards 1.2s, pulseRing 2.5s ease-out infinite 3s",
                  }}
                >
                </div>
              </div>
              <div
                class="bg-zinc-900/80 border border-white/5 p-5 rounded-xl w-full group-hover:border-indigo-400/30 transition-colors opacity-0"
                style={{ animation: "cardSlideIn 0.8s ease-out forwards 1.2s" }}
              >
                <h4 class="text-white font-bold mb-1">
                  Phase 1: Cloud Foundation & Target Analysis
                </h4>
                <p class="text-sm text-zinc-400 leading-relaxed">
                  Provision Google Cloud Project schemas, deploy isolated Deno
                  mock endpoints, and validate ML edge integration architecture
                  constraints.
                </p>
              </div>
            </div>
            ...
            <div class="flex items-center space-x-6 relative z-10 w-full group">
              ...
              <div class="w-6 h-6 rounded-full bg-black border-2 border-cyan-400 shrink-0 shadow-[0_0_15px_rgba(34,211,238,0.4)] flex items-center justify-center relative">
                ...
                <div
                  class="absolute inset-0 rounded-full bg-cyan-400 opacity-0"
                  style={{
                    animation:
                      "pulseRing 1.5s ease-out forwards 2.2s, pulseRing 2.5s ease-out infinite 4s",
                  }}
                >
                </div>
              </div>
              <div
                class="bg-zinc-900/80 border border-white/5 p-5 rounded-xl w-full group-hover:border-cyan-400/30 transition-colors opacity-0"
                style={{ animation: "cardSlideIn 0.8s ease-out forwards 2.2s" }}
              >
                <h4 class="text-white font-bold mb-1">
                  Phase 2: Database Migration & Vector Seeding
                </h4>
                <p class="text-sm text-zinc-400 leading-relaxed">
                  Map monolithic Oracle relational tables to Firestore,
                  batch-generate 512D ArcFace matrices via bulk seeder workers,
                  and verify strict index integrity.
                </p>
              </div>
            </div>
            ...
            {/* Phase 3 */}
            <div class="flex items-center space-x-6 relative z-10 w-full group">
              <div class="w-20 font-mono text-xs text-emerald-500 text-right shrink-0 font-bold tracking-widest">
                WK 6
              </div>
              <div class="w-6 h-6 rounded-full bg-black border-2 border-emerald-400 shrink-0 flex items-center justify-center shadow-[0_0_15px_rgba(52,211,153,0.4)] relative">
                <div
                  class="absolute inset-0 rounded-full bg-emerald-400 opacity-0"
                  style={{ animation: "pulseRing 1.5s ease-out forwards 3.2s" }}
                >
                </div>
                <svg
                  class="w-4 h-4 text-emerald-400 opacity-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  style={{
                    animation:
                      "checkPop 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards 3.2s",
                  }}
                >
                  <path
                    stroke-linecap="round"
              ...
              <div
                class="bg-emerald-900/10 border border-emerald-500/30 p-5 rounded-xl w-full opacity-0"
                style={{ animation: "cardSlideIn 0.8s ease-out forwards 3.2s" }}
              >
                <h4 class="text-emerald-400 font-bold mb-1">
                  Phase 3: UAT & Production Cut-over
                </h4>
                <p class="text-sm text-emerald-100/60 leading-relaxed">
                  Execute User Acceptance Testing against the shadow index,
                  seamlessly switch global DNS traffic routing to the Edge Load
                  Balancer, and officially decommission idle Oracle hardware.
                </p>
              </div>
            </div>
          </div>
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-5xl space-y-12 slide-in px-4">
          <div class="text-center space-y-4">
            ...
            <p class="text-lg text-zinc-400 max-w-2xl mx-auto font-light">
              Every quarter of delay compounds technical debt, increases
              migration risk, and surrenders competitive ground.
            </p>
          </div>
          ...
          <div class="w-full max-w-3xl flex flex-col space-y-5 mt-4">
            <div class="bg-red-950/20 border border-red-500/20 p-6 rounded-xl flex items-start space-x-5 group hover:border-red-500/40 transition-colors">
              ...
              <div>
                <h4 class="text-white font-bold text-lg mb-1">
                  Legacy Support Lifecycle Closing
                </h4>
                <p class="text-sm text-zinc-400 leading-relaxed">
                  Oracle 23ai extended support and FPGA firmware update windows
                  are narrowing. Migrating proactively avoids emergency
                  cut-overs under deadline pressure with zero runway for
                  testing.
                </p>
              </div>
            </div>
            ...
            <div class="bg-amber-950/20 border border-amber-500/20 p-6 rounded-xl flex items-start space-x-5 group hover:border-amber-500/40 transition-colors">
              <div class="w-14 h-14 rounded-xl bg-amber-500/10 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(245,158,11,0.2)]">
                ...
                >
                  ...
                  <path
                    d="M6 18 v -4 a 6 2.5 0 0 0 12 0 v 4"
                    stroke-width="1.5"
                  />
                  <path
                    d="M6 14 v -4 a 6 2.5 0 0 0 12 0 v 4"
                    stroke-width="1.5"
                    opacity="0.6"
                  />
                  ...
                  <g>
                    ...
                    />
                    <path
                      d="M6 10 v -2 a 6 2.5 0 0 0 12 0 v 2"
                      stroke-width="1.5"
                    />
              ...
              <div>
                ...
                <p class="text-sm text-zinc-400 leading-relaxed">
                  Every month on legacy infrastructure burns ~$42K in idle
                  Oracle licensing plus FPGA power and cooling costs that
                  serverless completely eliminates from day one.
                </p>
              </div>
            </div>
            ...
            <div class="bg-cyan-950/20 border border-cyan-500/20 p-6 rounded-xl flex items-start space-x-5 group hover:border-cyan-500/40 transition-colors">
              ...
              <div>
                ...
                <p class="text-sm text-zinc-400 leading-relaxed">
                  Vector search is becoming table stakes. Organizations that
                  modernize now capture first-mover advantage in AI-native
                  product experiences while laggards are still procuring
                  hardware.
                </p>
              </div>
            </div>
    ...
    },
    {
      ...
      content: (
        <div class="flex flex-col items-center justify-center w-full max-w-4xl space-y-10 slide-in px-4 relative min-h-[60vh]">
          ...
          <div
            class="absolute inset-[-30%] -z-10 flex items-center justify-center opacity-25 pointer-events-none"
            style={{
              maskImage:
                "radial-gradient(ellipse at center, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 70%)",
              WebkitMaskImage:
          ...
          <h1 class="text-5xl md:text-7xl font-light tracking-tight text-white text-center">
            Thank{" "}
            <span class="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-400">
              You
            </span>
          </h1>
          ...
          <div class="flex items-center justify-center space-x-6 md:space-x-12 mt-6 mb-4">
            <div class="flex items-center text-sm md:text-base font-mono uppercase tracking-widest text-amber-400">
              <div class="w-2 h-2 rounded-full bg-amber-400 mr-3 animate-pulse">
              </div>{" "}
              Cheaper to Run
            </div>
            <div class="flex items-center text-sm md:text-base font-mono uppercase tracking-widest text-blue-400">
              <div class="w-2 h-2 rounded-full bg-blue-400 mr-3 animate-pulse">
              </div>{" "}
              Faster to Build
            </div>
            <div class="flex items-center text-sm md:text-base font-mono uppercase tracking-widest text-emerald-400">
              <div
                class="w-2 h-2 rounded-full bg-emerald-400 mr-3 animate-pulse"
          ...
          <div class="mt-6 bg-zinc-900/60 backdrop-blur-xl border border-white/10 px-10 py-5 rounded-2xl text-center glow-border-hover relative">
            ...
            <p class="text-2xl font-light text-zinc-200 relative z-10">
              Questions?
            </p>
            <p class="text-sm text-zinc-500 mt-2 font-mono tracking-widest relative z-10">
              We'd love to hear from you.
            </p>
          </div>

          <div class="mt-8 flex flex-col md:flex-row items-center justify-between gap-8 border-t border-white/10 pt-6 w-full max-w-sm">
            <div class="flex items-center space-x-4">
              <img
                src="/eric_warriner.jpg"
                class="w-12 h-12 rounded-full border border-white/10 object-cover shadow-[0_0_15px_rgba(34,211,238,0.2)]"
                alt="Eric S. Warriner"
              />
              <div class="flex flex-col text-left">
                ...
                <span class="text-[10px] text-cyan-400 font-mono tracking-widest uppercase mt-0.5">
                  Cloud Application<br/>Modernization Engineer
                </span>
              </div>
            </div>
            
            <div class="flex flex-col items-center">
              <div class="p-1.5 bg-white/90 rounded-lg shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all transform hover:scale-105">
                <img
                  src="/qrcode.png"
                  class="w-14 h-14 object-contain mix-blend-multiply"
                  alt="QR Code to Application"
                />
              </div>
              <span class="text-[8px] text-zinc-400 font-mono tracking-[0.2em] uppercase mt-2 text-center w-full block">
                Scan Demo
              </span>
            </div>
          </div>
  ...
  const PRESENTER_NOTES = [
    ...
    // 7: architecture-pitch
    {
      ...
      points: [
        {
          color: "text-purple-400",
          heading: "Escaping the Hardware Trap",
          text:
            "The fundamental problem with FPGA-based architectures is that your intelligence is physically fused to specific silicon. When a new breakthrough model releases — and they release constantly — you cannot adopt it without a hardware refresh cycle that takes months of procurement, installation, and validation. Our architecture completely inverts this. The model is a software file. When a better model appears on HuggingFace or a research paper, we swap the ONNX file and redeploy. Zero hardware changes. Zero downtime. Instant iteration.",
        },
        {
          color: "text-purple-400",
          heading: "Containerized Elastic Scale",
          text:
            "On the backend, Cloud Run containers scale automatically from zero to thousands of instances based on demand, and back to zero when traffic drops. There are no server racks to order, no capacity planning meetings, no idle hardware burning electricity. This architecture is designed to cost nothing when it's not being used, and scale infinitely when it is.",
        },
      ],
      pitch:
        "Software-defined intelligence outpaces physical hardware lifecycles every single time.",
    },
    // 8: privacy-gdpr
    {
      ...
      pitch:
        "Mathematical abstraction is the ultimate privacy shield. No images on the server means no images to breach.",
    },
    // 9: data-flow
    {
    ...
    // 10: tco-slide
    {
      ...
      points: [
        {
          color: "text-amber-400",
          heading: "The Financial Case",
          text:
            "Let me put concrete numbers on this. Our current Oracle infrastructure carries a per-processor licensing cost of approximately $47,500 per year, plus FPGA hardware that depreciates on a 3-to-5-year cycle with a $500,000+ initial capital expenditure. The Google Cloud alternative runs on consumption pricing — you pay per query, per millisecond of compute, per gigabyte of storage. When the system is idle, the cost is literally zero dollars. Cloud Run scales to zero. Firestore charges only for reads and writes. There is no idle burn rate.",
        },
        {
          color: "text-amber-400",
          heading: "CapEx to OpEx Transformation",
          text:
            "Beyond the raw cost savings, this migration converts a capital expenditure line item — hardware procurement that lands on the balance sheet and depreciates — into an operating expenditure that scales linearly with actual business value delivered. The CFO sees cleaner financials, predictable monthly billing, and zero depreciation schedules to manage. The infrastructure becomes a utility, not an asset.",
        },
      ],
      pitch:
        "From $500K+ in hardware capital expenditure to zero-dollar idle costs. The infrastructure disappears from the balance sheet.",
    },
    // 11: code-splitting
    {
      ...
      pitch:
        "Five lines of code replaced hundreds of lines of proprietary Oracle PL/SQL. That is the power of native cloud simplicity.",
    },
    // 12: business-value
    {
    ...
    // 13: implementation-timeline
    {
      ...
      points: [
        ...
        {
          color: "text-emerald-400",
          heading: "Phase 3 — Week 6: UAT & Cut-over",
          text:
            "Week six is production cut-over. We execute User Acceptance Testing against the shadow index, run accuracy validation to confirm search quality matches or exceeds the legacy system, seamlessly switch global DNS traffic routing to the new Edge Load Balancer, and officially decommission the idle Oracle hardware. Six weeks from kickoff to production.",
        },
      ],
      pitch:
        "Six weeks from kickoff to full production. The old system stays live throughout — zero disruption to operations.",
    },
    // 14: why-now
    {
      title: "Why Act Now?",
    ...
    // 15: closing
    {
      ...
      pitch:
        "Cheaper to run. Faster to build. Safer to operate. The time to modernize is now.",
    },
  ];
  ...
  return (
    <div class="relative w-full h-screen overflow-hidden bg-[#050505] text-white flex flex-col font-sans selection:bg-cyan-500/30">
      ...
      <div class="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-cyan-900/10 rounded-full blur-[120px] pointer-events-none opacity-40">
      </div>
      ...
      <main class="flex-grow flex items-center justify-center p-4 md:p-12 z-10 w-full h-[calc(100vh-100px)] relative">
        <div
          key={currentSlide}
          class="w-full h-full flex items-center justify-center animate-slideFadeIn"
        >
      ...
      <div class="absolute bottom-[72px] left-0 right-0 flex justify-center z-20 pointer-events-none">
        <div
          ...
          class="flex items-center space-x-2 animate-slideFadeIn"
        >
          <div
          ...
          <span
            class={`text-[9px] font-mono uppercase tracking-[0.25em] ${currentTheme.color} opacity-60`}
          >
            {currentTheme.label}
          </span>
        </div>
      ...
      {showSpeakerNotes && (
        <div
          class="absolute inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md"
          onClick={() => setShowSpeakerNotes(false)}
        >
          <div
            class="bg-zinc-950 border border-white/10 p-8 md:p-12 rounded-3xl max-w-3xl w-full text-left shadow-[0_0_50px_rgba(0,0,0,0.8)] relative slide-in"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Glow effect */}
            <div class="absolute inset-0 bg-gradient-to-b from-cyan-500/5 to-purple-500/5 blur-xl rounded-3xl pointer-events-none">
            </div>

            <button
              class="absolute top-6 right-6 text-zinc-500 hover:text-white transition-colors bg-white/5 hover:bg-white/10 p-2 rounded-full border border-white/10"
              onClick={() => setShowSpeakerNotes(false)}
            >
              <svg
                class="w-5 h-5"
            ...
            <div class="flex items-center space-x-3 mb-6 relative z-10">
              ...
              <h3 class="text-xs font-mono text-cyan-400 uppercase tracking-widest">
                Presenter Talking Points
              </h3>
            </div>

            <h2 class="text-3xl font-light text-white mb-8 tracking-tight relative z-10">
              {currentNotes.title}
            </h2>

            <div
              class="space-y-6 text-zinc-300 text-[15px] leading-relaxed relative z-10 max-h-[50vh] overflow-y-auto pr-2"
              style={{
                scrollbarWidth: "thin",
            ...
            >
              {currentNotes.points.map((pt: any, i: number) => (
                ...
                >
                  <p>
                    <strong
                      class={`${pt.color} font-semibold mb-2 block tracking-wide`}
                    >
                      {pt.heading}
                    </strong>
                    "{pt.text}"
              ...
              <div class="mt-8 p-5 bg-zinc-900 rounded-xl border border-white/5 border-l-4 border-l-amber-500 shadow-inner">
                <p class="font-mono text-amber-500 text-xs mb-2 uppercase tracking-widest">
                  The Elevator Pitch
                </p>
      ...
      <div class="absolute bottom-5 right-6 pointer-events-auto z-40 group cursor-default">
        <div class="flex items-center space-x-2 opacity-20 group-hover:opacity-100 transition-opacity duration-700">
          <svg
            class="w-3 h-3 text-cyan-400 group-hover:text-cyan-300 transition-colors"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            stroke-width="2"
          ...
          <p class="text-[8px] text-zinc-400 font-mono tracking-widest uppercase">
            Engineered with{" "}
            <span class="text-white">Google Antigravity IDE</span>
          </p>
        </div>
      </div>
    </div>
